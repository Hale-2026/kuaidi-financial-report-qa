...
行业：快递物流
公司：17 家（快递主干 7 家 + 物流延伸 10 家；其中 A 股 14 家、港股 3 家）
...
下载源（三源，互为交叉验证）：
  ...
  3) 港交所披露易        https://www1.hkexnews.hk/search/titleSearchServlet.do —— 港股公司

  注：上交所 query.sse.com.cn 接口在本机网络环境下返回空结果，故沪市公司统一走巨潮
      （该平台为沪市公司法定披露渠道，公告原文与上交所一致）。每个源都做了重试与
      降级，失败的尝试同样记进 manifest（带 note 说明原因），便于逐条回溯。
